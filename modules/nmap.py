...
def execute_nmap(target):
    ...
    # Ejecutar Nmap
    command = f"nmap -Pn -sS -sV --min-rate 10000 --max-retries 3 -p 80,443 {target} -vv"
    ...
    save_output_to_file(result, RESULTS_FOLDERPATH + target+'_nmap'+RESULTS_FILEEXTENSION, original_target)
